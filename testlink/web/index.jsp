...
//          alert(JSON.stringify(User1));
              document.getElementsById("user_name").value=JSON.stringify(User1);
              alert(document.getElementsById("user_name").value);
          }
      </script>
  </head>
  <body>

  <form  action="/servlet/com.link.servlet.SaveServlet" method="post">
     ...
     4 <input type="text" name="email4"><br>
      ...
      <input  type="button" value="xx" onclick="xx();">
  </form>
  </body>
